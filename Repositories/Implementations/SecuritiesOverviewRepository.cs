...
namespace Temperance.Constellations.Repositories.Implementations
{
    public class SecuritiesOverviewRepository : ISecuritiesOverviewRepository
    {
        ...
        public async Task<bool> UpdateSecuritiesOverview(int securityId, SecurityOverviewModel securitiesOverview)
        {
        ...
        public async Task<SecurityOverviewModel> GetSecurityOverview(string symbol)
        {
            ...
            return await connection.QueryFirstOrDefaultAsync<SecurityOverviewModel>(query, new { Symbol = symbol });
        }
