...
using Temperance.Constellations.Models.Conductor;         // For DTOs including AiTradingDecisionResponseDto, PortfolioSnapshotDto, SimpleBarDto
using Temperance.Constellations.Models.HistoricalPriceData; // For PriceModel (used in ITradingStrategy interface)
using Temperance.Constellations.Models.Trading;             // For Position, SignalDecision, TradeSummary (used in ITradingStrategy interface)
...
namespace Temperence.Services.Trading.Strategies.Omniscient.Implementation
{
    public class ClaudeDecisionStrategy : ISingleAssetStrategy
    {
        ...
        public SignalDecision GenerateSignal(PriceModel currentBar, IReadOnlyList<PriceModel> historicalDataWindow)
        {
        ...
        public bool ShouldExitPosition(Position position, PriceModel currentBar, IReadOnlyList<PriceModel> historicalDataWindow)
        {
        ...
        public decimal GetAllocationAmountAi(PriceModel currentBar, IReadOnlyList<PriceModel> historicalDataWindow, decimal maxTradeAllocation)
        {
